...
Bank040000_FrontHeaderLikeData_040000:
	include "src/reference_gfx_bank/front_data_blocks.asm"
...
Bank040000_FlaggedRomReferenceTables_041000:
	include "src/reference_gfx_bank/flagged_rom_reference_tables.asm"

Bank040000_LocalTableTargetedPayloadFront_041C00:
	include "src/reference_gfx_bank/targeted_record_blocks_front.asm"

Bank040000_LocalTableTargetedPayloadMid_04A70F:
	include "src/reference_gfx_bank/targeted_record_blocks_mid.asm"

Bank040000_LocalTableTargetedPayloadLate_04E5AA:
	include "src/reference_gfx_bank/targeted_record_blocks_late.asm"

Bank040000_LocalTableTargetedPayloadTail_05FC30:
	include "src/reference_gfx_bank/targeted_record_blocks_tail.asm"
