...
; still unresolved.
	...
	include "src/bank080000_table_targeted_payload_front.asm"
...
; inline incbins.
	include "src/bank080000_table_targeted_payload_mid.asm"
	include "src/bank080000_table_targeted_payload_late.asm"
	include "src/bank080000_table_targeted_payload_late_tail.asm"
...
; and 0x0A3476+ families.
	include "src/bank080000_table_targeted_payload_tail.asm"
