...
; ======================================================================
	bne.w CheckMenuInput	; $1400
	btst.b #$5, (RAM_PlayerState).w	; $1404
	beq.w CheckPlayerActive	; $140A
	bsr.w SceneTransitionTick	; $140E
...
ActionEnterDoor:
	...
	bsr.w SceneTransitionStart	; $1480
	...
	subq.w #$2, D0	; $149A
	adda.w D0, A2	; $149C
ActionEnterDoor_Store:
	move.l A2, (-$7386,A0)	; $149E
	bra.b *+$4	; $14A2
ActionEnterDoor_Done:
	rts	; $14A4
CheckPlayerActive:
	btst.b #$0, (RAM_PlayerState).w	; $14A6
	beq.b *+$1C	; $14AC
	bsr.w SceneTransitionWait	; $14AE
...
RenderFullScene_Col:
	...
	addq.w #$1, D6	; $1720
	subq.w #$1, D3	; $1722
	bne.b RenderFullScene_Col	; $1724
	addq.w #$1, D7	; $1726
	dbf D4, $1716	; $1728
RenderFullScene_Done:
	rts	; $172C
SceneTransitionWait:
...
SceneTransitionRenderRow:
	addq.w #$1, D6	; $17BC
		dc.w	$6000,$0890	; bra.w
SceneTransitionRender_Done:
	rts	; $17C2
	rts	; $17C4
	move.b (A2)+, D3	; $17C6
	move.b (RAM_word_FFFF8CAF).w, D2	; $17C8
	bra.w SceneEventDispatch2	; $17CC
...
FormatNumber_Loop:
	...
	subi.b #$40, D2	; $1876
SceneCmd_Text2:
	bra.w SceneEventDispatch2	; $187A
...
SceneCmd_Subroutine:
	...
	tst.b D0	; $19F6
	bmi.w SceneEventSkip	; $19F8
	addq.l #$2, A2	; $19FC
	beq.w SceneEventSkip	; $19FE
	addq.l #$2, A2	; $1A02
	...
	bra.w SceneEventDispatch2	; $1A4C
	move.w #-$7FE0, D0	; $1A50
	moveq #$1, D7	; $1A54
...
SceneCmd_Random_Count:
	addq.b #$1, D1	; $1B2A
	tst.b (A0)+	; $1B2C
	bne.b SceneCmd_Random_Count	; $1B2E
	subq.b #$1, D2	; $1B30
	bpl.b SceneCmd_Random_Count	; $1B32
	st -(A0)	; $1B34
	subq.b #$1, D1	; $1B36
	move.b D1, (A1)+	; $1B38
	subq.w #$1, D7	; $1B3A
	cmpi.b #$5, D7	; $1B3C
	bcc.b SceneCmd_Random	; $1B40
...
SceneCmd_AddGold:
	...
	bls.w SceneEventSkip	; $1C28
SceneCmd_SkipData:
	addq.w #$2, A2	; $1C2C
	bra.w RunSceneEventScript	; $1C2E
	cmpi.w #$E00, (RAM_word_FFFF9F00).w	; $1C32
SceneCmd_GoldCheck:
	bcc.w SceneEventSkip	; $1C38
	bra.b SceneCmd_SkipData	; $1C3C
	moveq #$C, D0	; $1C3E
	cmp.b (RAM_word_FFFF95BE).w, D0	; $1C40
	bne.b SceneCmd_SkipData	; $1C44
	cmp.b (RAM_word_FFFF95BF).w, D0	; $1C46
	bne.b SceneCmd_SkipData	; $1C4A
	cmp.b (RAM_word_FFFF95C0).w, D0	; $1C4C
	bne.b SceneCmd_SkipData	; $1C50
	cmp.b (RAM_word_FFFF95C1).w, D0	; $1C52
	bne.b SceneCmd_SkipData	; $1C56
	cmp.b (RAM_word_FFFF95C2).w, D0	; $1C58
	bne.b SceneCmd_SkipData	; $1C5C
	bra.w SceneEventSkip	; $1C5E
	movea.w (RAM_word_FFFF9EEE).w, A0	; $1C62
	move.w (-$2600,A0), D0	; $1C66
	cmp.w (RAM_word_FFFF9F00).w, D0	; $1C6A
	bra.b SceneCmd_GoldCheck	; $1C6E
	bsr.w	$8E9C				; $1C70
	bra.b SceneCmd_SkipData	; $1C74
	tst.w (RAM_word_FFFF9F32).w	; $1C76
	bmi.b SceneCmd_SkipData	; $1C7A
	bra.w SceneEventSkip	; $1C7C
...
QuizTextBack:
	...
	bra.b QuizTextLoop	; $1E90
QuizTextControl:
	cmpi.b #$10, D3	; $1E92
	bcc.b *+$1E	; $1E96
	cmpi.b #$C, D3	; $1E98
QuizTextControl_Wait:
	bcs.w QuizTextControl_Wait	; $1E9C
	move.b (A2)+, D0	; $1EA0
...
BuildTextLine_Copy:
	...
	move.w D0, (A2)+	; $1F30
	subq.w #$1, D1	; $1F32
	bne.b BuildTextLine_Copy	; $1F34
BuildTextLine_Render2:
	move.w #-$7FE0, D1	; $1F36
	move.w D1, D0	; $1F3A
			dc.w	$41fa,$00c1	; dc.w
	bsr.w CopyChars	; $1F40
	rts	; $1F44
FormatNumberLine:
	link	A6, #-$C			; $1F46
	dc.w	$6160	; 1F4A
	...
	move.w D1, D0	; $1F72
			dc.w	$41fa,$007b	; dc.w
	bsr.w CopyChars	; $1F78
	movea.l A1, A0	; $1F7C
	bsr.w CopyChars	; $1F7E
			dc.w	$41fa,$0074	; dc.w
	bsr.w CopyChars	; $1F86
	unlk A6	; $1F8A
	rts	; $1F8C
CopyChars:
	move.w D1, D2	; $1F8E
CopyChars_Loop:
	...
	move.b D0, D2	; $1F9A
	subi.b #$40, D2	; $1F9C
	bra.b CopyChars_Loop	; $1FA0
CopyChars_Store:
	move.w D0, ($40,A2)	; $1FA2
	move.w D2, (A2)+	; $1FA6
	bra.b CopyChars	; $1FA8
CopyChars_Done:
	rts	; $1FAA
FillLine:
	lea (-$72EE).w, A0	; $1FAC
...
RenderTilemapRow:
	...
	move.w	D2, D1				; $20BA
	lea	(-$7258).w, A2			; $20BC
RenderTilemapPlane_Col:
	andi.w	#$7E, D2			; $20C0
RenderTilemapPlane_ColWait:
	move.w	(A1), D0			; $20C4
	btst	#$9, D0				; $20C6
	beq.b	RenderTilemapPlane_ColWait			; $20CA
	move.w	D3, D0				; $20CC
	add.w	D4, D0				; $20CE
	or.w	D2, D0				; $20D0
	andi.w	#$FFE, D0			; $20D2
	...
	addq.w	#$2, D2				; $20E0
	subq.w	#$1, D5				; $20E2
	bne.b	RenderTilemapPlane_Col			; $20E4
	move.w	(RAM_RenderCols).w, D5		; $20E6
	lea	(-$7258).w, A2			; $20EA
RenderTilemapPlane_Col2:
	andi.w	#$407E, D1			; $20EE
	move.w	D3, D0				; $20F2
	or.w	D1, D0				; $20F4
	swap	D0				; $20F6
	...
	addq.w	#$2, D1				; $2100
	subq.w	#$1, D5				; $2102
	bne.b	RenderTilemapPlane_Col2			; $2104
	addq.w	#$1, D7				; $2106
	subq.w	#$1, D6				; $2108
...
WriteScrollRegs:
	...
	subq.w	#$3, D3				; $21F4
WriteScrollRegs_Tile:
	move.w	D5, D0				; $21F6
	bsr.w	$2050				; $21F8
	addq.w	#$1, D6				; $21FC
	dbf	D3, WriteScrollRegs_Tile			; $21FE
	swap	D5				; $2202
	move.w	D5, D0				; $2204
